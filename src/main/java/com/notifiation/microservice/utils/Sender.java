package com.notifiation.microservice.utils;
...
public class Sender {
	...
	private final String 			  emailBodyForBuildStatus =
			"<font face=\"arial\">Please find in the mail the the build status." +
					"<br>Should you have any question regarding this mail, thank you to contact " +
					"<a href = \"mailto: msouissi2@myges.fr\">." +
					"<br>Best regards,<br><br><strong>The ESGI CI notification team</strong></font>";
	@Autowired
